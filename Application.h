...
// Segway Slaughter
//
// Time-stamp: <Last modified 2010-01-29 17:08:45 by Eric Scrivner>
//
// Description:
...
public:
  ...
  //
  // Updates necessary systems each frame, classes which override this method
  // should have something like the following at the start of their own
  // frameStarted method:
  //
